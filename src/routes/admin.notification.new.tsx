...
export const Route = createFileRoute("/admin/notification/new")({
  head: () => ({ meta: [{ title: "New Notification — Freshly Admin" }, { name: "description", content: "Compose and deliver a customer notification campaign." }] }),
