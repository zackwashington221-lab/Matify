...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Freshly — Buy groceries online with AI-curated picks" },
      ...
      { property: "og:title", content: "Freshly — Buy groceries online with AI-curated picks" },
        ...
        <div className="relative mx-auto max-w-7xl px-4 lg:px-8 py-16 lg:py-24 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-5 text-base lg:text-lg text-muted-foreground leading-relaxed max-w-xl">
              Shop thousands of everyday essentials from local growers and artisan makers. Freshly's assistant plans meals,
