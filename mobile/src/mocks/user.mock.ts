...
export const mockUser: User = { id: "demo-user", name: "Alex Morgan", email: "alex@martify.test", role: "Customer" };
...
export const mockProducts: Product[] = [
  { _id: "avocado", slug: "organic-avocado", name: "Organic Avocado", brand: "Martify Farms", description: "Creamy Hass avocados picked for today.", price: 3.99, unit: "each", emoji: "🥑", imageUrl: "https://images.unsplash.com/photo-1523049673822-e5e0ff5d5e0b?auto=format&fit=crop&w=600&q=70", category: "produce", rating: 4.8, organic: true, aiTag: "AI pick" },
  ...
  { _id: "tomatoes", slug: "vine-tomatoes", name: "Vine Tomatoes", brand: "Martify Farms", description: "Sweet vine-ripened tomatoes.", price: 3.25, unit: "500g", emoji: "🍅", imageUrl: "https://images.unsplash.com/photo-1592924357228-91a4daadcfea?auto=format&fit=crop&w=600&q=70", category: "produce", rating: 4.5 },
