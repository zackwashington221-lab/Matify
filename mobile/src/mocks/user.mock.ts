...
export const mockProducts: Product[] = [
  ...
  { _id: "eggs", slug: "free-range-eggs", name: "Free Range Eggs", brand: "Meadow & Hen", description: "Large free-range eggs from local farms.", price: 5.95, unit: "12 pack", emoji: "🥚", category: "dairy", rating: 4.8, organic: true },
  { _id: "pasta", slug: "bronze-cut-pasta", name: "Bronze Cut Pasta", brand: "Casa Verde", description: "Traditional durum wheat spaghetti.", price: 3.8, unit: "500g", emoji: "🍝", category: "pantry", rating: 4.6 },
  { _id: "coffee", slug: "single-origin-coffee", name: "Single Origin Coffee", brand: "Roast House", description: "Rich medium-roast whole beans.", price: 14.5, unit: "340g", emoji: "☕", category: "pantry", rating: 4.9, aiTag: "Customer favourite" },
  { _id: "peas", slug: "garden-peas", name: "Garden Peas", brand: "Harvest Freezer", description: "Sweet frozen peas, picked at peak freshness.", price: 3.4, unit: "500g", emoji: "🫛", category: "frozen", rating: 4.4 },
  { _id: "sparkling-water", slug: "sparkling-water", name: "Sparkling Water", brand: "Spring & Co.", description: "Naturally sparkling mineral water.", price: 4.2, unit: "6 × 330ml", emoji: "💧", category: "drinks", rating: 4.5 },
];
